...
const SECTIONS = [
  ...
  { id: 'riesgo-relaciones', label: 'Niños y relaciones' },
  { id: 'beneficios', label: 'Lo bueno de la IA' },
  { id: 'un-plan', label: 'Un plan mundial' },
  { id: 'nuevo-sistema', label: 'Un nuevo sistema' },
  { id: 'reservado-humanos', label: 'Reservado para humanos' },
  { id: 'tributacion', label: 'Tributar trabajo y capital' },
  { id: 'que-hago', label: 'Lo que estoy haciendo' },
];
    ...
    <div className="max-w-6xl mx-auto py-10 sm:py-14 px-5 sm:px-8">
      ...
      <article ref={articleRef} className="relative w-full max-w-3xl bg-paper-raised border border-rule">
        ...
        <div className="p-8 md:p-12 text-ink text-lg leading-relaxed space-y-7 font-sans">
          ...
          {/* RIESGO 1 */}
          <h3 id="riesgo-empleos" className="font-display text-ribbon font-semibold text-2xl mt-10 mb-4">Muchos empleos desaparecerán para siempre.</h3>
          <p>
          ...
          {/* RIESGO 2 */}
          <h3 id="riesgo-dano" className="font-display text-ribbon font-semibold text-2xl mt-10 mb-4">La IA empoderará a las personas (y quizás a las IAs) para hacer más daño.</h3>
          <p>
          ...
          {/* RIESGO 3 */}
          <h3 id="riesgo-relaciones" className="font-display text-ribbon font-semibold text-2xl mt-10 mb-4">La IA podría estancar el desarrollo de nuestros hijos y reemplazar las relaciones humanas.</h3>
          <p>
          ...
          {/* BENEFICIOS */}
          <h3 id="beneficios" className="font-display text-ribbon font-semibold text-2xl mt-10 mb-4">Las cosas buenas que hacemos con la IA podrían ser muy, muy buenas.</h3>
          <p>
          ...
          {/* EL PLAN */}
          <h3 id="un-plan" className="font-display text-ribbon font-semibold text-2xl mt-10 mb-4">El mundo necesita un plan.</h3>
          <p>
          ...
          <h3 id="nuevo-sistema" className="font-display text-ribbon font-semibold text-2xl mt-10 mb-4">Construir un nuevo sistema para manejar la transición.</h3>
          <p>
          ...
          <h3 id="reservado-humanos" className="font-display text-ribbon font-semibold text-2xl mt-10 mb-4">Reservar algunos trabajos para humanos.</h3>
          <p>
          ...
          <h3 id="tributacion" className="font-display text-ribbon font-semibold text-2xl mt-10 mb-4">Reequilibrar cómo tributamos el trabajo y el capital.</h3>
          <p>
          ...
          <h3 id="que-hago" className="font-display text-ribbon font-semibold text-2xl mt-10 mb-4">Lo que estoy haciendo.</h3>
          <p>
