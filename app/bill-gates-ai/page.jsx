  ...
  return (
    <div className="max-w-3xl mx-auto py-10 px-4 sm:px-6">
      ...
      <article className="bg-gray-900 border border-gray-800 rounded-2xl overflow-hidden shadow-2xl">
        ...
        <header className="p-8 md:p-12 border-b border-gray-800 bg-gradient-to-b from-sky-900/20 to-transparent">
        ...
        <div className="p-8 md:p-12 text-gray-300 text-lg leading-relaxed space-y-7 font-sans">
          ...
          <blockquote className="my-10 p-6 md:p-8 bg-emerald-400/5 border-l-4 border-emerald-500 rounded-r-xl text-xl md:text-2xl italic text-gray-200 font-light">
          ...
          {/* RIESGO 1 */}
          <p>
            <strong className="text-sky-400 font-semibold text-xl block mt-8 mb-4">Muchos empleos desaparecerán para siempre.</strong> 
          ...
          {/* RIESGO 2 */}
          <p>
            <strong className="text-sky-400 font-semibold text-xl block mt-8 mb-4">La IA empoderará a las personas (y quizás a las IAs) para hacer más daño.</strong> 
          ...
          {/* RIESGO 3 */}
          <p>
            <strong className="text-sky-400 font-semibold text-xl block mt-8 mb-4">La IA podría estancar el desarrollo de nuestros hijos y reemplazar las relaciones humanas.</strong> 
          ...
          {/* BENEFICIOS */}
          <p>
            <strong className="text-sky-400 font-semibold text-xl block mt-8 mb-4">Las cosas buenas que hacemos con la IA podrían ser muy, muy buenas.</strong> 
          ...
          {/* EL PLAN */}
          <p>
            <strong className="text-sky-400 font-semibold text-xl block mt-8 mb-4">El mundo necesita un plan.</strong> 
          ...
          <p>
            <strong className="text-sky-400 font-semibold text-xl block mt-8 mb-4">Construir un nuevo sistema para manejar la transición.</strong> 
          ...
          <p>
            <strong className="text-sky-400 font-semibold text-xl block mt-8 mb-4">Reservar algunos trabajos para humanos.</strong> 
          ...
          <p>
            <strong className="text-sky-400 font-semibold text-xl block mt-8 mb-4">Reequilibrar cómo tributamos el trabajo y el capital.</strong> 
          ...
          <p>
            <strong className="text-sky-400 font-semibold text-xl block mt-8 mb-4">Lo que estoy haciendo.</strong> 
          ...
          <div className="mt-8 pt-8 border-t border-gray-800 flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
